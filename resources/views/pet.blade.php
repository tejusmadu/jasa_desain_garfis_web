...
<body>
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="{{ asset('image/') }}" class="card-img-top" alt="Desain Logo">
                <div class="card-body">
                    <h5 class="card-title">Vecktor pet</h5>
                    <p class="card-text">-</p>
        ...
        <div class="col-md-4">
           ...
           <div class="col-md-4">
            <div class="card">
                <img src="{{ asset('image/pet.jpg') }}" class="card-img-top" alt="Desain Logo">
                <div class="card-body">
                    <h5 class="card-title">Vecktor pet</h5>
                    <p class="card-text">-</p>
                    <p class="card-text"><strong>Price: $99.99</strong></p>
