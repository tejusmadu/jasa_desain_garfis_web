...
<header class="jumbotron">
  <div class="container text-center">
    ...
    <p class="lead">Get your job done by experts in various fields.</p>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card service-card">
          <img src="{{ asset('image/vecktor.png') }}" class="card-img-top" alt="Desain Vecktor">
          <div class="card-body">
            <h5 class="card-title">Desain Vecktor</h5>
            <p class="card-text">Find talented graphic designers for your project.</p>
      ...
      <div class="col-md-4">
        <div class="card service-card">
          <img src="{{ asset('image/pet.jpg') }}" class="card-img-top" alt="Desain Vecktor Pet">
          <div class="card-body">
            <h5 class="card-title">Desain Vecktor Pet</h5>
            <p class="card-text">Hire skilled developers to build your website or web app.</p>
            <a href="pet" class="btn btn-primary">Browse</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card service-card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Get professional writers and translators for your content needs.</p>
            <a href="logo" class="btn btn-primary">Browse</a>
          </div>
        </div>
      </div>
    </div>
